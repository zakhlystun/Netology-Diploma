...
public class DebitTest {
    ...
    public void shouldSuccessfulDebitPurchase() {
        ...
        assertEquals("APPROVED", SQLHelper.getDebitStatusFromDatabase());
    }
    ...
    @Test
    @DisplayName("ТС-1.3.5 Неверно заполнено поле Номер карты,  16 нулей")
    ...
    @Test
    @DisplayName("ТС-1.4.6 Неверно заполнено поле Месяц, срок действия карты истек")
    ...
    @Test
    @DisplayName("ТС-1.5.5 Неверно заполнено поле Год, нули")
    ...
    @Test
    @DisplayName("ТС-1.6.2 Неверно заполнено поле Владелец, ввод цифр")
